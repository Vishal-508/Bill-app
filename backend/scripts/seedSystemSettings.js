...
const DEFAULT_SETTINGS = [
  ...
  // ═══ GENERAL — Forecast tuning (Prompt 8 Section C) ═══
  // All read at runtime by forecast.service.js — admin can tune without restart.
  {
    key: 'FORECAST_AUTO_RUN',
    label: 'Forecast Auto-Run Enabled',
    category: 'GENERAL',
    description: 'Master switch for the nightly forecast cron job',
    value: true,
    defaultValue: true,
    valueType: 'boolean',
    displayOrder: 70,
  ...
  },
  {
    ...
    category: 'GENERAL',
    description: 'How many months ahead to forecast (default 6)',
    value: 6,
    defaultValue: 6,
    valueType: 'number',
    displayOrder: 71,
  ...
  {
    key: 'FORECAST_HW_ALPHA',
    label: 'Holt-Winters Alpha (level smoothing)',
    category: 'GENERAL',
    description: 'Smoothing weight for the level component (0.0-1.0; default 0.5)',
    value: 0.5,
    defaultValue: 0.5,
    valueType: 'number',
    displayOrder: 72,
  ...
  {
    key: 'FORECAST_HW_BETA',
    label: 'Holt-Winters Beta (trend smoothing)',
    category: 'GENERAL',
    description: 'Smoothing weight for the trend component (0.0-1.0; default 0.4)',
    value: 0.4,
    defaultValue: 0.4,
    valueType: 'number',
    displayOrder: 73,
  ...
  {
    key: 'FORECAST_HW_GAMMA',
    label: 'Holt-Winters Gamma (seasonal smoothing)',
    category: 'GENERAL',
    description: 'Smoothing weight for the seasonal component (0.0-1.0; default 0.6)',
    value: 0.6,
    defaultValue: 0.6,
    valueType: 'number',
    displayOrder: 74,
  ...
  // ═══ GENERAL — Cron job toggles (Prompt 8 Section F) ═══
  {
    key: 'ANALYTICS_AUTO_COMPUTE',
    label: 'Daily Analytics Cron Enabled',
    category: 'GENERAL',
    description: 'Master switch for the nightly consumption-analytics cron (11 PM daily)',
    value: true,
    defaultValue: true,
    valueType: 'boolean',
    displayOrder: 75,
  ...
  },
  {
    ...
    label: 'Weekly Admin Report Enabled',
    category: 'GENERAL',
    description: 'Master switch for the weekly admin summary email (Mondays 8 AM)',
    value: true,
    defaultValue: true,
    valueType: 'boolean',
    displayOrder: 76,
  ...
  },
  {
    ...
    label: 'Weekly Report Recipient Email',
    category: 'GENERAL',
    description: 'Where to send the weekly summary (falls back to NOTIFICATION_ADMIN_ALERT_EMAIL, then EMAIL_FROM)',
    value: '',
    defaultValue: '',
    valueType: 'string',
    displayOrder: 77,
